...
independent license and is not affiliated with, endorsed by, or derived from
any third-party licensing organization.
...
a) Revenue Threshold: The global gross revenue of your Company, excluding
value-added tax and other sales taxes, for the most recently completed fiscal
year did not exceed 2,000,000 EUR (or the equivalent in any other currency).

b) Headcount Threshold: Your Company currently employs or engages a total
workforce of no more than 50 full-time equivalents (FTEs). This calculation
includes all employees, part-time employees, and independent contractors,
prorated based on their actual working hours or engagement, and follows the
...
Software, and nothing in this Section restricts running the Software or training
your own models through the capabilities the Software provides.
...
remove or obscure any notice, nor represent the Software, or any work derived
from it, as your own original work or under a different name in a way that
...
"Your Company" is any legal entity, sole proprietorship, or other organization
that you work for, plus all organizations that have control over, are under the
control of, or are under common control with that organization. "Control" means
